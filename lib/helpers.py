...
class ScrewSpecFactory:
    ...
    def _base_detail_params(**overrides) -> dict:
        defaults = {
            ...
            "standard_torsion": 0.5,
            "standard_torsion_ule": 0.1,
            "standard_torsion_lle": 0.1,
            "standard_speed": 500,
            "standard_speed_ule": 100,
            "standard_speed_lle": 100,
            "standard_angel": 360,
            "standard_angel_ule": 50,
            "standard_angel_lle": 50,
            "standard_time": 1000,
            "standard_time_ule": 200,
            "standard_time_lle": 200,
        }
    ...
    def complex_full(cls, spec_id: int) -> dict:
        return {
            ...
            "detail_params": cls._base_detail_params(
                ...
                standard_torsion=2.0,
                standard_torsion_ule=0.5,
                standard_torsion_lle=0.3,
                standard_speed=800,
                standard_speed_ule=200,
                standard_speed_lle=150,
                standard_angel=720,
                standard_angel_ule=100,
                standard_angel_lle=80,
                standard_time=2000,
                standard_time_ule=500,
                standard_time_lle=400,
            ),
            "step_params": [
                cls._base_step(
                    i,
    ...
    def random(cls, spec_id: int) -> dict:
        ...
        return {
            ...
            "detail_params": cls._base_detail_params(
                ...
                gyrometer_stop_angle=random.randint(330, 360),
                confirm_cnt=random.randint(1, 5),
                vel_limit_torque_percent=random.randint(50, 100),
                torque_filter_time_ms=random.randint(5, 50),
                standard_torsion=round(random.uniform(0.1, 5.0), 2),
                standard_torsion_ule=round(random.uniform(0.05, 1.0), 2),
                standard_torsion_lle=round(random.uniform(0.05, 1.0), 2),
                standard_speed=random.randint(100, 1000),
                standard_speed_ule=random.randint(50, 300),
                standard_speed_lle=random.randint(50, 300),
                standard_angel=random.randint(90, 1080),
                standard_angel_ule=random.randint(10, 200),
                standard_angel_lle=random.randint(10, 200),
                standard_time=random.randint(500, 5000),
                standard_time_ule=random.randint(100, 1000),
                standard_time_lle=random.randint(100, 1000),
            ),
            "step_params": [
                cls._base_step(
                    i,
